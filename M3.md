...
What's interesting is that we also used [Euclid's Algorithm](https://en.wikipedia.org/wiki/Greatest_common_divisor#Euclid's_algorithm) for calculateing GCD ([Greatest Common Divisor](https://en.wikipedia.org/wiki/Greatest_common_divisor) not [Gong Chan Dang](https://en.wikipedia.org/?title=Gongchandang&redirect=no)).
