...
We can divide the problem into three sub-tasks: [Swap](#swap), [Sort](#sort) and Test. 
...
If we have large number of elements to sort, we'll need to use a better [sorting algorithm](https://en.wikipedia.org/wiki/Sorting_algorithm).
